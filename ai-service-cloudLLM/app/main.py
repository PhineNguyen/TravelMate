...
app = FastAPI(
    title="TravelMate AI Service (Groq)",
    version="1.0.0",
    description="Microservice AI Cloud (Groq LLM + Geoapify) - Feature-Based"
)
...
def root():
    return {
        ...
        "message": "TravelMate Groq AI Service is ready (Feature-Based)!"
    }
