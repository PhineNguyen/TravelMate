...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (userRepository.count() == 0) {
            ...
            String[] userNames = {"Nguyễn Văn A", "Trần Thị B", "Lê Hoàng C", "Phạm Thu D", "Hoàng Bảo E"};
            String[] emails = {"nguyenvana@gmail.com", "tranthib@gmail.com", "lehoangc@yahoo.com", "phamthud@outlook.com", "hoangbaoe@gmail.com"};
            String[] avatarUrls = {
            ...
            String[] placeNames = {"Chợ Bến Thành", "Hồ Hoàn Kiếm", "Phố cổ Hội An", "Vịnh Hạ Long", "Chợ đêm Phú Quốc"};
            String[] addresses = {"Quận 1, TP. HCM", "Quận Hoàn Kiếm, Hà Nội", "Hội An, Quảng Nam", "Hạ Long, Quảng Ninh", "Phú Quốc, Kiên Giang"};
            String[] cities = {"Hồ Chí Minh", "Hà Nội", "Hội An", "Hạ Long", "Phú Quốc"};
            ExpenseCategory[] categories = {ExpenseCategory.SHOPPING, ExpenseCategory.ENTERTAINMENT, ExpenseCategory.ENTERTAINMENT, ExpenseCategory.ENTERTAINMENT, ExpenseCategory.FOOD};

            String[] templateTitles = {"Sài Gòn 3 Ngày 2 Đêm", "Hà Nội - Sapa", "Đà Nẵng - Hội An", "Hạ Long Cuối Tuần", "Khám phá Phú Quốc"};
            String[] descriptions = {
